...
% draw the sieves
\node[block,anchor=north,text width=6.4cm] (tray0) at (0,0) {PDB-файл
   {\begin{itemize}
...
\node[block, below = of tray0,text width=7.4cm] (tray1) {маскировка части позиций};

\node[block,below right = of tray1,text width=7.4cm] (tray2) {Построение тетраэдризации Делоне и двойственного графа};
   
\node[block,below = of tray2,text width=7.4cm] (tray3) {Выбор начальных треугольников на границе тетраэдризации};
