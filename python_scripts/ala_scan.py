...
"""
This script is based on Ala-Scan demo script from pyRosetta by Evan H. Baugh.

The main difference - scanning is performed for selected subset of aminoacids
in docked pair of chains (not for all aminoacids in chains).
"""

# modified methods, description unchanged
